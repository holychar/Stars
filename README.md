# Stars [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)]
...
- [os-tutorial - How to create a OS from Scratch](https://github.com/cfenollosa/os-tutorial)
- [radare2 - UNIX-Like reverse engineering framework](https://github.com/radareorg/radare2)
- [x86-x86-64 disassembler library](https://github.com/zyantific/zydis)
- [Detect sandbox and analysis like malware families do](https://github.com/a0rtega/pafish)
...
- [Exploitation framework](https://github.com/malwaredllc/byob)
- [Yeti](https://github.com/yeti-platform/yeti)
- [Public tools from unit42](https://github.com/pan-unit42/public_tools)
...
- [Servo Web Browser](https://github.com/servo/servo)
- [Fuzzer and content discovery tool](https://github.com/phra/rustbuster)
